...
const latex_rules = [
  ...
  ['\\\\var\\s*{\\s*[a-zA-Z0-9\\+\\-\\\\.:_ ]+\\s*}(?:\\s*{\\s*[a-zA-Z0-9\\+\\-\\\\.:_ ]+\s*})?', 'VARMULTICHAR'],
...
const appliedFunctionSymbolsDefault = ["abs", "exp", "log", "ln", "log10", "sign", "sqrt", "erf", "acos", "acosh", "acot", "acoth", "acsc", "acsch", "asec", "asech", "asin", "asinh", "atan", "atanh", "cos", "cosh", "cot", "coth", "csc", "csch", "sec", "sech", "sin", "sinh", "tan", "tanh", 'arcsin', 'arccos', 'arctan', 'arccsc', 'arcsec', 'arccot', 'cosec', 'arg', 'floor', 'ceil', 'round', 'fix'];
  ...
  baseFactor({ inside_absolute_value = 0,
    ...
    if (this.token.token_type === 'NUMBER') {
      ...
      if (this.token.token_type === 'LATEXCOMMAND') {
        ...
        result = /\\var\s*\{\s*([a-zA-Z0-9\+\-.:_\\ ]+)\s*\}/.exec(result)[1];
      }
